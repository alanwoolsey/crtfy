...
const focusAreas = [
  ...
  { icon: FileStack, title: 'Crtfy Documents', description: 'Education-first content management for intake, repository workflows, e-forms, signatures, retention, and governed search.' },
]
    ...
    <>
      <section className="page-hero">
        <div className="container narrow-hero">
          ...
          <h1>A product company for governed operational software.</h1>
          <p className="lead-copy centered-copy">
            Crtfy builds SaaS products for teams that manage sensitive records, AI-assisted work, student lifecycle operations, and reviewable institutional workflows.
          </p>
        </div>
      </section>
        ...
        <div className="container two-column-story">
          ...
          <div className="story-panel">
            <div className="callout-card">
              <h3>Our direction</h3>
              <p>
                The Crtfy portfolio is intentionally centered on SaaS products. We are narrowing the brand around Crtfy.ai, Crtfy Student, and Crtfy Documents so customers can quickly understand what each product does and where it fits.
              </p>
            </div>
          </div>
        </div>
