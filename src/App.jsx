    ...
    <header className="site-header">
      <div className="container nav-shell">
        <NavLink to="/" className="brand">
          <div>
            <BrandLogo />
            <div className="brand-sub">Governed SaaS Education-First products</div>
          </div>
        </NavLink>
      ...
      <div className="container footer-grid">
        <div>
          <div className="footer-brand">
            <div>
              ...
              <p>Governed SaaS products for AI, students, and documents.</p>
            </div>
          </div>
          <p className="footer-copy">
            Crtfy helps education and operations teams replace fragmented tools with governed workspaces, source-grounded AI, and workflow-native records systems.
          </p>
        </div>
        <div>
          <h4>Explore</h4>
        ...
        <div>
          ...
          <div className="footer-list">
            ...
            <span><GraduationCap size={16} /> Student operating system</span>
            <span><FileStack size={16} /> Document operations</span>
        ...
        <div>
          ...
          <div className="footer-links">
            ...
            <NavLink to="/products/crtfy-documents">Crtfy Documents</NavLink>
          </div>
        </div>
      </div>
    </footer>
